...
void LevelMeter::resized()
{
    ...
    levelGradient = juce::ColourGradient(juce::Colour::fromRGBA(0xFF, 0xF0, 0x44, 0xAA), backgroundRect.getX(), backgroundRect.getBottom(), juce::Colour::fromRGBA(0xE4, 0x67, 0x2F, 0xAA), backgroundRect.getX(), y, false);
